...
def GetDataSource(*Retain_items):
    ...
    Source_Directory    = "/Users/Deepak/suganths_terminal/Suganth's Git/Global-Warming-Using-Machine-Learning/"
...
def main():
    ...
    ##### SINCE MAY MONTH IS THE HOTTEST IN INDIA, WE WILL GET THE MAY MONTH DATASET ALONE
    ##### FOR EVERY YEAR AND OPERATE BASED ON THAT DATASET
    ...
    dependent_pred = dependent_pred.reshape((dependent_pred.size,1))
    ...
    # >>>>>>>> PLOT THE GRAPH OF YOUR MODEL HERE WITH THE TEST SET
